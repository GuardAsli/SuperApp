# GuardAsli — تجربه کلاینت (مثل ExpressVPN / NordVPN)
...
| **Provider (3X-UI و …)** | پروتکل واقعی، ترافیک، inbound |
| **اپ روی گوشی/دسکتاپ** | UI Connect/Disconnect، kill switch، تونل سیستم‌عامل |

کنترل‌پلن **جایگزین هسته TUN سیستم‌عامل نیست**؛ مثل بک‌آفیس نورد، وضعیت و config را می‌دهد و کلاینت تونل را برقرار می‌کند.
